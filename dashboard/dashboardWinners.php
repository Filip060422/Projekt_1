...
function displayWinners() {
    ...
    if(!$search){
        if(isset($_POST['positionsWinners'])) {
            $positionsWinners = $_POST['positionsWinners'];
        } else {
            $positionsWinners = 5;
        }
    ...
    $q = "SELECT 
        ...
        LEFT JOIN 
            surveynps ON scores.surveyID = surveynps.surveyID WHERE scores.win = 1 LIMIT $positionsWinners;";
...
<body>
    <div class="container">
        ...
        <section class="main-area users">
                <div class="buttons">
                    <form action="dashboardUsers.php" method="post">
                        <button type="submit" class="button-users">Lista uczestników</button>
                        <button type="button" class="button-winners button-margin">Lista zwycięzców</button>
                    </form> 
                </div>
                <form action="dashboardWinners.php" method="post" id="myForm">
                        ...
                        <div class="bottom-main-area">
                            <div class="left">
                                ...
                                <label for="positions">Pokaż</label>
                                    <select name="positionsWinners" onchange="submitForm()">
